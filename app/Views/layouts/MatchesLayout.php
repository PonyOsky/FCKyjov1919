...
<body>
    ...
    <main>
    <h1 class="heading" style="margin: 1% 0">Aktuální výsledky posledních zápasů</h1>
    <div class="miniNav"><a class="mnIcon" href="<?= base_url('/') ?>"><i class="fa-solid fa-house priColor"></i></a><i class="fa-solid fa-arrow-right mnIcon"></i>Zápasy</div>
    <div class="offVisi">
    <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
        <i class="fa-solid fa-chevron-right iconH"></i>
    </button></div>
